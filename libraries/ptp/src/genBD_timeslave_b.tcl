...
proc create_hier_cell_clock_and_resets { parentCell nameHier } {
  ...
  connect_bd_net -net cmac_usplus_qsfp_b_gt_txusrclk2 [get_bd_pins usr_tx_clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  connect_bd_net -net cmac_usplus_qsfp_b_usr_tx_reset [get_bd_pins usr_tx_reset] [get_bd_pins proc_sys_reset_0/ext_reset_in]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: cmac_usplus_qsfp_b, and set properties
  set cmac_usplus_qsfp_b [ create_bd_cell -type ip -vlnv xilinx.com:ip:cmac_usplus:3.1 cmac_usplus_qsfp_b ]
  set_property -dict [ list \
...
#  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins loopback_fifo/M_AXIS] [get_bd_intf_pins timeslave_0/usr_s_axis]
  #connect_bd_intf_net -intf_net cmac_usplus_qsfp_b_axis_rx [get_bd_intf_pins cmac_usplus_qsfp_b/axis_rx] [get_bd_intf_pins timeslave_0/mac_s_axis]
  connect_bd_intf_net -intf_net cmac_usplus_qsfp_b_gt_serial_port [get_bd_intf_ports gt] [get_bd_intf_pins cmac_usplus_qsfp_b/gt_serial_port]
  connect_bd_intf_net -intf_net gt_ref_clk_0_1 [get_bd_intf_ports gt_ref] [get_bd_intf_pins cmac_usplus_qsfp_b/gt_ref_clk]
#   connect_bd_intf_net -intf_net jtag_axi_0_M_AXI [get_bd_intf_pins jtag_axi_0/M_AXI] [get_bd_intf_pins jtag_axi_0_axi_periph/S00_AXI]
  #connect_bd_intf_net -intf_net jtag_axi_0_axi_periph_M00_AXI [get_bd_intf_pins cmac_usplus_qsfp_b/s_axi] [get_bd_intf_pins jtag_axi_0_axi_periph/M00_AXI]
#   connect_bd_intf_net -intf_net jtag_axi_0_axi_periph_M01_AXI [get_bd_intf_pins jtag_axi_0_axi_periph/M01_AXI] [get_bd_intf_pins timeslave_0/s_axi]
  connect_bd_intf_net -intf_net timeslave_0_mac_m_axis [get_bd_intf_pins cmac_usplus_qsfp_b/axis_tx] [get_bd_intf_pins timeslave_0/mac_m_axis]
  

  # Create port connections
  #connect_bd_net -net Net [get_bd_pins clock_and_resets/gt_ref_clk] [get_bd_pins cmac_usplus_qsfp_b/drp_clk] [get_bd_pins cmac_usplus_qsfp_b/gt_ref_clk_out] [get_bd_pins cmac_usplus_qsfp_b/init_clk]
  connect_bd_net -net cmac_usplus_qsfp_b_gt_rxusrclk2 [get_bd_pins cmac_usplus_qsfp_b/gt_rxusrclk2] [get_bd_pins timeslave_0/now_clk_0]
  
  #connect_bd_net -net cmac_usplus_qsfp_b_gt_txusrclk2 [get_bd_pins clock_and_resets/usr_tx_clk] [get_bd_pins cmac_usplus_qsfp_b/gt_txusrclk2] [get_bd_pins cmac_usplus_qsfp_b/rx_clk] [get_bd_pins loopback_fifo/s_axis_aclk] [get_bd_pins timeslave_0/now_clk_1] [get_bd_pins timeslave_0/now_clk_2] [get_bd_pins timeslave_0/s_axis_aclk]
  connect_bd_net -net cmac_usplus_qsfp_b_gt_txusrclk2 [get_bd_pins clock_and_resets/usr_tx_clk] [get_bd_pins cmac_usplus_qsfp_b/gt_txusrclk2] [get_bd_pins cmac_usplus_qsfp_b/rx_clk] [get_bd_pins timeslave_0/now_clk_1] [get_bd_pins timeslave_0/now_clk_2] [get_bd_pins timeslave_0/s_axis_aclk]

  connect_bd_net -net cmac_usplus_qsfp_b_rx_preambleout [get_bd_pins cmac_usplus_qsfp_b/rx_preambleout] [get_bd_pins cmac_usplus_qsfp_b/tx_preamblein]
  connect_bd_net -net cmac_usplus_qsfp_b_rx_ptp_tstamp_out [get_bd_pins cmac_usplus_qsfp_b/rx_ptp_tstamp_out] [get_bd_pins timeslave_0/ptp_rx_tstamp]
  connect_bd_net -net cmac_usplus_qsfp_b_tx_ptp_tstamp_out [get_bd_pins cmac_usplus_qsfp_b/tx_ptp_tstamp_out] [get_bd_pins timeslave_0/ptp_tx_tstamp]
  connect_bd_net -net cmac_usplus_qsfp_b_tx_ptp_tstamp_valid_out [get_bd_pins cmac_usplus_qsfp_b/tx_ptp_tstamp_valid_out] [get_bd_pins timeslave_0/ptp_tx_tstamp_valid]
  connect_bd_net -net cmac_usplus_qsfp_b_usr_tx_reset [get_bd_pins clock_and_resets/usr_tx_reset] [get_bd_pins cmac_usplus_qsfp_b/usr_tx_reset]
  ...
  #connect_bd_net -net proc_sys_reset_2_peripheral_reset [get_bd_pins clock_and_resets/peripheral_reset] [get_bd_pins cmac_usplus_qsfp_b/core_drp_reset] [get_bd_pins cmac_usplus_qsfp_b/sys_reset]
...
#  connect_bd_net -net s_axi_aclk_0_1 [get_bd_ports clk_100MHz] [get_bd_pins clock_and_resets/clk_100MHz] [get_bd_pins cmac_usplus_qsfp_b/s_axi_aclk] [get_bd_pins jtag_axi_0/aclk] [get_bd_pins jtag_axi_0_axi_periph/ACLK] [get_bd_pins jtag_axi_0_axi_periph/M00_ACLK] [get_bd_pins jtag_axi_0_axi_periph/M01_ACLK] [get_bd_pins jtag_axi_0_axi_periph/S00_ACLK] [get_bd_pins timeslave_0/s_axi_aclk]
  connect_bd_net -net s_axi_aclk_0_1 [get_bd_ports clk_100MHz] [get_bd_pins clock_and_resets/clk_100MHz] [get_bd_pins cmac_usplus_qsfp_b/s_axi_aclk] 
  connect_bd_net -net s_axi_sreset_0_1 [get_bd_ports clk_100_reset] [get_bd_pins clock_and_resets/clk_100_reset] [get_bd_pins cmac_usplus_qsfp_b/s_axi_sreset]
  connect_bd_net -net timeslave_0_now_0 [get_bd_pins cmac_usplus_qsfp_b/ctl_rx_systemtimerin] [get_bd_pins timeslave_0/now_0]
  connect_bd_net -net timeslave_0_now_1 [get_bd_pins cmac_usplus_qsfp_b/ctl_tx_systemtimerin] [get_bd_pins timeslave_0/now_1]
  connect_bd_net -net timeslave_0_tx_1588op [get_bd_pins cmac_usplus_qsfp_b/tx_ptp_1588op_in] [get_bd_pins timeslave_0/tx_1588op]
...
connect_bd_net [get_bd_ports CMAC_Clk] [get_bd_pins cmac_usplus_qsfp_b/gt_txusrclk2]
...
connect_bd_net [get_bd_ports CMAC_rx_locked] [get_bd_pins cmac_usplus_qsfp_b/stat_rx_aligned]

create_bd_port -dir O CMAC_usr_tx_reset
connect_bd_net [get_bd_ports CMAC_usr_tx_reset] [get_bd_pins cmac_usplus_qsfp_b/usr_tx_reset]

create_bd_port -dir I CMAC_ctl_tx_enable
connect_bd_net [get_bd_ports CMAC_ctl_tx_enable] [get_bd_pins cmac_usplus_qsfp_b/ctl_tx_enable]
create_bd_port -dir I CMAC_ctl_rx_enable
connect_bd_net [get_bd_ports CMAC_ctl_rx_enable] [get_bd_pins cmac_usplus_qsfp_b/ctl_rx_enable]

create_bd_port -dir I CMAC_ctl_tx_lfi
connect_bd_net [get_bd_ports CMAC_ctl_tx_lfi] [get_bd_pins cmac_usplus_qsfp_b/ctl_tx_send_lfi]

create_bd_port -dir I CMAC_ctl_tx_rfi
connect_bd_net [get_bd_ports CMAC_ctl_tx_rfi] [get_bd_pins cmac_usplus_qsfp_b/ctl_tx_send_rfi]

create_bd_port -dir O CMAC_rx_local_fault
connect_bd_net [get_bd_ports CMAC_rx_local_fault] [get_bd_pins cmac_usplus_qsfp_b/stat_rx_internal_local_fault]

create_bd_port -dir I CMAC_Master_reset
connect_bd_net [get_bd_ports CMAC_Master_reset] [get_bd_pins cmac_usplus_qsfp_b/core_rx_reset]
connect_bd_net [get_bd_ports CMAC_Master_reset] [get_bd_pins cmac_usplus_qsfp_b/sys_reset]
connect_bd_net [get_bd_ports CMAC_Master_reset] [get_bd_pins cmac_usplus_qsfp_b/core_drp_reset]
connect_bd_net [get_bd_ports CMAC_Master_reset] [get_bd_pins cmac_usplus_qsfp_b/core_tx_reset]
connect_bd_net [get_bd_ports CMAC_Master_reset] [get_bd_pins cmac_usplus_qsfp_b/gtwiz_reset_tx_datapath]
connect_bd_net [get_bd_ports CMAC_Master_reset] [get_bd_pins cmac_usplus_qsfp_b/gtwiz_reset_rx_datapath]

create_bd_port -dir I -from 11 -to 0 gt_loopback_in
connect_bd_net [get_bd_ports gt_loopback_in] [get_bd_pins cmac_usplus_qsfp_b/gt_loopback_in]

connect_bd_net [get_bd_ports clk_100MHz] [get_bd_pins cmac_usplus_qsfp_b/init_clk]
connect_bd_net [get_bd_ports clk_100MHz] [get_bd_pins cmac_usplus_qsfp_b/drp_clk]

# ...........................................................
# STATS SIGNALS FROM CMAC IP TO BD PORT MAPPING
create_bd_port -dir O -from 2 -to 0 stat_rx_bad_code
connect_bd_net [get_bd_ports stat_rx_bad_code] [get_bd_pins cmac_usplus_qsfp_b/stat_rx_bad_code]

create_bd_port -dir O -from 2 -to 0 stat_rx_bad_fcs
connect_bd_net [get_bd_ports stat_rx_bad_fcs] [get_bd_pins cmac_usplus_qsfp_b/stat_rx_bad_fcs]

create_bd_port -dir O -from 2 -to 0 stat_rx_stomped_fcs
connect_bd_net [get_bd_ports stat_rx_stomped_fcs] [get_bd_pins cmac_usplus_qsfp_b/stat_rx_stomped_fcs]

create_bd_port -dir O stat_rx_packet_bad_fcs
connect_bd_net [get_bd_ports stat_rx_packet_bad_fcs] [get_bd_pins cmac_usplus_qsfp_b/stat_rx_packet_bad_fcs]

create_bd_port -dir O stat_tx_total_packets
connect_bd_net [get_bd_ports stat_tx_total_packets] [get_bd_pins cmac_usplus_qsfp_b/stat_tx_total_packets]

create_bd_port -dir O  stat_tx_total_good_packets
connect_bd_net [get_bd_ports stat_tx_total_good_packets] [get_bd_pins cmac_usplus_qsfp_b/stat_tx_total_good_packets]

create_bd_port -dir O -from 2 -to 0 stat_rx_total_packets
connect_bd_net [get_bd_ports stat_rx_total_packets] [get_bd_pins cmac_usplus_qsfp_b/stat_rx_total_packets]

create_bd_port -dir O  stat_rx_total_good_packets
connect_bd_net [get_bd_ports stat_rx_total_good_packets] [get_bd_pins cmac_usplus_qsfp_b/stat_rx_total_good_packets]

create_bd_port -dir O  stat_rx_packet_64_bytes
connect_bd_net [get_bd_ports stat_rx_packet_64_bytes] [get_bd_pins cmac_usplus_qsfp_b/stat_rx_packet_64_bytes]
create_bd_port -dir O  stat_rx_packet_65_127_bytes
connect_bd_net [get_bd_ports stat_rx_packet_65_127_bytes] [get_bd_pins cmac_usplus_qsfp_b/stat_rx_packet_65_127_bytes]
create_bd_port -dir O  stat_rx_packet_128_255_bytes
connect_bd_net [get_bd_ports stat_rx_packet_128_255_bytes] [get_bd_pins cmac_usplus_qsfp_b/stat_rx_packet_128_255_bytes]
create_bd_port -dir O  stat_rx_packet_256_511_bytes
connect_bd_net [get_bd_ports stat_rx_packet_256_511_bytes] [get_bd_pins cmac_usplus_qsfp_b/stat_rx_packet_256_511_bytes]
create_bd_port -dir O  stat_rx_packet_512_1023_bytes
connect_bd_net [get_bd_ports stat_rx_packet_512_1023_bytes] [get_bd_pins cmac_usplus_qsfp_b/stat_rx_packet_512_1023_bytes]
create_bd_port -dir O  stat_rx_packet_1024_1518_bytes
connect_bd_net [get_bd_ports stat_rx_packet_1024_1518_bytes] [get_bd_pins cmac_usplus_qsfp_b/stat_rx_packet_1024_1518_bytes]
create_bd_port -dir O  stat_rx_packet_1519_1522_bytes
connect_bd_net [get_bd_ports stat_rx_packet_1519_1522_bytes] [get_bd_pins cmac_usplus_qsfp_b/stat_rx_packet_1519_1522_bytes]
create_bd_port -dir O  stat_rx_packet_1523_1548_bytes
connect_bd_net [get_bd_ports stat_rx_packet_1523_1548_bytes] [get_bd_pins cmac_usplus_qsfp_b/stat_rx_packet_1523_1548_bytes]
create_bd_port -dir O  stat_rx_packet_1549_2047_bytes
connect_bd_net [get_bd_ports stat_rx_packet_1549_2047_bytes] [get_bd_pins cmac_usplus_qsfp_b/stat_rx_packet_1549_2047_bytes]
create_bd_port -dir O  stat_rx_packet_2048_4095_bytes
connect_bd_net [get_bd_ports stat_rx_packet_2048_4095_bytes] [get_bd_pins cmac_usplus_qsfp_b/stat_rx_packet_2048_4095_bytes]
create_bd_port -dir O  stat_rx_packet_4096_8191_bytes
connect_bd_net [get_bd_ports stat_rx_packet_4096_8191_bytes] [get_bd_pins cmac_usplus_qsfp_b/stat_rx_packet_4096_8191_bytes]
create_bd_port -dir O  stat_rx_packet_8192_9215_bytes
connect_bd_net [get_bd_ports stat_rx_packet_8192_9215_bytes] [get_bd_pins cmac_usplus_qsfp_b/stat_rx_packet_8192_9215_bytes]

create_bd_port -dir O -from 2 -to 0 stat_rx_packet_small
connect_bd_net [get_bd_ports stat_rx_packet_small] [get_bd_pins cmac_usplus_qsfp_b/stat_rx_packet_small]
create_bd_port -dir O -from 2 -to 0 stat_rx_undersize
connect_bd_net [get_bd_ports stat_rx_undersize] [get_bd_pins cmac_usplus_qsfp_b/stat_rx_undersize]
create_bd_port -dir O -from 2 -to 0 stat_rx_fragment
connect_bd_net [get_bd_ports stat_rx_fragment] [get_bd_pins cmac_usplus_qsfp_b/stat_rx_fragment]

create_bd_port -dir O  stat_rx_packet_large
connect_bd_net [get_bd_ports stat_rx_packet_large] [get_bd_pins cmac_usplus_qsfp_b/stat_rx_packet_large]
create_bd_port -dir O  stat_rx_unicast
connect_bd_net [get_bd_ports stat_rx_unicast] [get_bd_pins cmac_usplus_qsfp_b/stat_rx_unicast]
create_bd_port -dir O  stat_rx_multicast
connect_bd_net [get_bd_ports stat_rx_multicast] [get_bd_pins cmac_usplus_qsfp_b/stat_rx_multicast]
create_bd_port -dir O  stat_rx_broadcast
connect_bd_net [get_bd_ports stat_rx_broadcast] [get_bd_pins cmac_usplus_qsfp_b/stat_rx_broadcast]
create_bd_port -dir O  stat_rx_oversize
connect_bd_net [get_bd_ports stat_rx_oversize] [get_bd_pins cmac_usplus_qsfp_b/stat_rx_oversize]
create_bd_port -dir O  stat_rx_toolong
connect_bd_net [get_bd_ports stat_rx_toolong] [get_bd_pins cmac_usplus_qsfp_b/stat_rx_toolong]
create_bd_port -dir O  stat_rx_bad_sfd
connect_bd_net [get_bd_ports stat_rx_bad_sfd] [get_bd_pins cmac_usplus_qsfp_b/stat_rx_bad_sfd]
create_bd_port -dir O  stat_rx_bad_preamble
connect_bd_net [get_bd_ports stat_rx_bad_preamble] [get_bd_pins cmac_usplus_qsfp_b/stat_rx_bad_preamble]
...
connect_bd_net [get_bd_ports CMAC_rx_axis_tdata] [get_bd_pins cmac_usplus_qsfp_b/rx_axis_tdata]

create_bd_port -dir O -from 63 -to 0 CMAC_rx_axis_tkeep
connect_bd_net [get_bd_ports CMAC_rx_axis_tkeep] [get_bd_pins cmac_usplus_qsfp_b/rx_axis_tkeep]

create_bd_port -dir O CMAC_rx_axis_tlast
connect_bd_net [get_bd_ports CMAC_rx_axis_tlast] [get_bd_pins cmac_usplus_qsfp_b/rx_axis_tlast]

create_bd_port -dir O CMAC_rx_axis_tuser
connect_bd_net [get_bd_ports CMAC_rx_axis_tuser] [get_bd_pins cmac_usplus_qsfp_b/rx_axis_tuser]

create_bd_port -dir O CMAC_rx_axis_tvalid
connect_bd_net [get_bd_ports CMAC_rx_axis_tvalid] [get_bd_pins cmac_usplus_qsfp_b/rx_axis_tvalid]

connect_bd_net [get_bd_pins timeslave_0/mac_s_axis_tdata] [get_bd_pins cmac_usplus_qsfp_b/rx_axis_tdata]
connect_bd_net [get_bd_pins timeslave_0/mac_s_axis_tkeep] [get_bd_pins cmac_usplus_qsfp_b/rx_axis_tkeep]
connect_bd_net [get_bd_pins timeslave_0/mac_s_axis_tlast] [get_bd_pins cmac_usplus_qsfp_b/rx_axis_tlast]
#connect_bd_net [get_bd_pins timeslave_0/mac_s_axis_tuser] [get_bd_pins cmac_usplus_qsfp_b/rx_axis_tuser]
connect_bd_net [get_bd_pins timeslave_0/mac_s_axis_tvalid] [get_bd_pins cmac_usplus_qsfp_b/rx_axis_tvalid]

# ......................................................................................................................

create_bd_port -dir O -from 79 -to 0 CMAC_rx_ptp_stamp
connect_bd_net [get_bd_ports CMAC_rx_ptp_stamp] [get_bd_pins cmac_usplus_qsfp_b/rx_ptp_tstamp_out]

create_bd_port -dir O -from 79 -to 0 CMAC_tx_ptp_stamp
connect_bd_net [get_bd_ports CMAC_tx_ptp_stamp] [get_bd_pins cmac_usplus_qsfp_b/tx_ptp_tstamp_out]
...
set_property name clk_b [get_bd_ports now_clk_3_0]
  ...
  #assign_bd_address -offset 0x00000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces jtag_axi_0/Data] [get_bd_addr_segs cmac_usplus_qsfp_b/s_axi/Reg] -force
