...
connect_bd_net [get_bd_ports Timeslave_ctrl_AXI_S_aclk] [get_bd_pins timeslave_0/s_axi_aclk]

create_bd_port -dir I -type rst Timeslave_ctrl_AXI_S_aresetn
connect_bd_net [get_bd_ports Timeslave_ctrl_AXI_S_aresetn] [get_bd_pins timeslave_0/s_axi_aresetn]
