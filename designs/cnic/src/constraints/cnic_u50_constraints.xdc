...
# PTP ARGs clock
set_max_delay 3.0 -datapath_only -from [get_clocks clk_300_ts_b_clk_wiz_0_0] -to [get_clocks clk_kernel_unbuffered]
set_max_delay 3.0 -datapath_only -from [get_clocks clk_kernel_unbuffered] -to [get_clocks clk_300_ts_b_clk_wiz_0_0]
